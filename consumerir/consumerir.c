...
#define DEEP_BUFFER_OUTPUT_PERIOD_SIZE 1024 // audio hal 960
...
static int consumerir_transmit(struct consumerir_device *dev __unused,
    ...
    audio_route_apply_path(audio_route, "irrc-lineout");
    audio_route_update_mixer(audio_route);
    audio_route_apply_path(audio_route, "irrc-playback");
    audio_route_update_mixer(audio_route);
